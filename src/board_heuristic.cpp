...
const value_t board_heuristic::value_king_middle[8][8] = 
{
    /* A */ {-60, -40, -20  -10, -10, -20, -40, -60},
    /* B */ {-40, -20, -10,  -5,  -5, -10, -20, -40},
    /* C */ {-20, -10,  -5,   0,   0,  -5, -10, -20},
    /* D */ {-10,  -5,   0,   5,   5,   0,  -5, -10},
    /* E */ {-10,  -5,   0,   5,   5,   0,  -5, -10},
    /* F */ {-20, -10,  -5,   0,   0,  -5, -10, -20},
    /* G */ {-40, -20, -10,  -5,  -5, -10, -20, -40},
    /* H */ {-60, -40, -20, -10, -10, -20, -40, -60}
            // 1    2    3    4    5    6    7    8
};
...
/*----------------------------------------------------------------------------*\
 |                                 evaluate()                                 |
\*----------------------------------------------------------------------------*/
value_t board_heuristic::evaluate() const
{
