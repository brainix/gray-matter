...
public:
	...
	void generate(list<move_t> &l, int type = MOVES) const;
	void make(move_t m);
	void unmake();
	void make(char *p);
...
private:
	...
	void generate_king(list<move_t> &l, int type = MOVES) const;
	void generate_queen(list<move_t> &l, int type = MOVES) const;
	void generate_rook(list<move_t> &l, int type = MOVES) const;
	void generate_bishop(list<move_t> &l, int type = MOVES) const;
	void generate_knight(list<move_t> &l, int type = MOVES) const;
	void generate_pawn(list<move_t> &l, int type = MOVES) const;
